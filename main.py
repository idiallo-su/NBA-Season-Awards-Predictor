...
if __name__ == '__main__':
    ...
    # ------------------------------------------------------------------------------------------------------------------
    def sentimentMultiplier(player_stats, sentiment_scores):
        # rank players by sentiment score
        ranked_players = sorted(player_stats, key=lambda x: sentiment_scores[x['player_name']], reverse=True)

        # apply multiplier to points category based on player ranking
        for i, player in enumerate(ranked_players):
            multiplier = i + 1  # increase multiplier for higher ranked players
    ...
    #2019-2020
    gAntetokounmpo2020 = [1, 63, 29.5, 13.6, 5.6, .553, .633]
    lJames2020 = [1, 67, 25.3, 7.8, 10.2, .493, .693]
    jHarden2020 = [4, 68, 34.3, 6.6, 7.5, .444, .865]
    lDoncic2020 = [7, 61, 28.8, 9.4, 8.8, .463, .758]
    kLeonard2020 = [2, 57, 27.1, 7.1, 4.9, .47, .886]
    aDavis2020 = [1, 62, 26.1, 9.3, 3.2, .503, .846]
    cPaul2020 = [5, 70, 17.6, 5.0, 6.7, .489, .907]
    dLillard2020 = [8, 66, 30.0, 4.3, 8.0, .463, .888]
    nJokic2020 = [3, 73, 19.9, 9.7, 7.0, .528, .817]
    pSiakam2020 = [2, 60, 22.9, 7.3, 3.5, .453, .792]
    jButler2020 = [6, 58, 19.9, 6.7, 6.0, .455, .834]
    jTatum2020 = [3, 66, 23.4, 7.0, 3.0, .450, .812]
    ...
    #2013-2014
    kDurant2014 = [2, 81, 32, 7.4, 5.5, .503, .873]
    lJames2014 = [2, 77, 27.1, 6.9, 6.3, .567, .750]
    bGriffin2014 = [3, 80, 24.1, 9.5, 3.9, .528, .715]
    jNoah2014 = [4, 80, 12.6, 11.3, 5.4, .475, .737]
    jHarden2014 = [4, 73, 25.4, 4.7, 6.1, .456, .866]
    sCurry2014 = [6, 78, 24.0, 4.3, 8.5, .471, .885]
    cPaul2014 = [3, 62, 19.1, 4.3, 10.7, .467, .885]
    aJefferson2014 = [7, 73, 21.8, 10.8, 2.1, .509, .690]
    pGeorge2014 = [1, 80, 21.7, 6.8, 3.5, .424, .864]
    lAldridge2014 = [5, 69, 23.2, 11.1, 2.6, .458, .822]
    kLove2014 = [10, 77, 26.1, 12.5, 4.4, .457, .821]
    tDuncan2014 = [1, 74, 15.1, 9.7, 3.0, .490, .731]
    tParker2014 = [1, 68, 16.7, 2.3, 5.7, .499, .811]
    dNowitzki2014 = [8, 80, 21.7, 6.2, 2.7, .497, .899]
    cAnthony2014 = [9, 77, 27.4, 8.1, 3.1, .452, .848]
    gDragic2014 = [9, 76, 20.3, 3.2, 5.9, .505, .760]
    mConley2014 = [7, 73, 17.2, 2.9, 6.0, .450, .815]
